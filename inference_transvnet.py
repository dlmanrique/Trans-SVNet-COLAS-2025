...
args.model_path = f'Transvnet_models/{args.dataset}/Transvnet_best_model.pth'
...
test_labels_80, test_num_each_80, test_start_vidx, test_paths = get_data(f'pkl_datasets_files/train_val_paths_labels_{dataset}.pkl')
...
test_we_use_start_idx_80 = [x for x in range(num_videos_dataset[dataset][1])]
...
os.makedirs(f'Transvnet_preds/{args.dataset}')
with open(f'Transvnet_preds/{args.dataset}/preds_phases.json', "w", encoding="utf-8") as f:
